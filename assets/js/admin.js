import { getAdminProducts, createAdminProduct, deleteAdminProduct } from "./services/adminProductService.js";
...
function renderAdminProducts(products) {
    ...
    products.forEach((product) => {
        ...
        editButton.addEventListener("click", () => {
            ...
            for (const field of [
                "name", "price", "screen", "backCamera",
                "frontCamera", "img", "desc"
            ]) {
...
function updateAdminList() {
    ...
    let matchingProducts = adminProducts.filter((product) =>
